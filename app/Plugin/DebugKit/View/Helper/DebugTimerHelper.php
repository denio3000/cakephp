 ...
 *
 * Tracks time and memory usage while rendering view.ctp.
 *
 */
 ...
 *
 * @param string $viewFile The view.ctp being rendered
 */
 ...
 *
 * @param string $viewFile The view.ctp being rendered
 * @param string $content The contents of the view.ctp.
 */
