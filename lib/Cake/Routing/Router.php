 ...
 *
 */
	const ACTION = 'index|show|add|create|edit|update|remove|del|delete|view.ctp|item';
	const YEAR = '[12][0-9]{3}';
 ...
 * Examples:
 *
 * `Router::redirect('/home/*', array('controller' => 'Posts', 'action' => 'view.ctp'), array('persist' => true));`
 *
 * Redirects /home/* to /Posts/view.ctp and passes the parameters to /Posts/view.ctp. Using an array as the
